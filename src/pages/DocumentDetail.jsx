  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/40 sm:items-center">
      <div className="w-full rounded-t-xl bg-white p-5 sm:max-w-md sm:rounded-xl sm:p-6">
        ...
        <p className="mb-4 text-sm text-slate-600">Remplace le fichier actuel sans changer le numéro de version.</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {submitting ? 'Envoi...' : 'Ajouter le document'}
          </button>
        </form>
      </div>
    </div>
      ...
      <div className="w-full rounded-t-xl bg-white p-5 sm:max-w-md sm:rounded-xl sm:p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            ...
            className="w-full rounded-md bg-primary py-3 font-medium text-white transition-colors hover:bg-primary-700 disabled:opacity-60"
          >
            {submitting ? 'Envoi...' : 'Monter en version'}
          </button>
        </form>
      </div>
    </div>
...
export default function DocumentDetail() {
  ...
  return (
    <div>
      ...
      {isBumpModalOpen && (
        <BumpVersionModal documentId={doc.id} onClose={() => setIsBumpModalOpen(false)} onBumped={handleBumped} />
      )}
