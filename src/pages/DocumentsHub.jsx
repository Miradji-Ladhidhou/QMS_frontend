...
import { CheckSquare, FileText, ScrollText } from 'lucide-react';
...
const TAB_COMPONENTS = { documents: Documents, 'my-approvals': MyApprovals, 'quality-policy': QualityPolicy };

// Fusionne Documents, Mes approbations et Politique qualité sous un seul lien de menu, même
// principe que CustomerFeedback.jsx — mais avec une contrainte propre à Politique qualité :
// ISO 9001 §5.2 exige qu'elle reste "communiquée, comprise et disponible" pour tout le tenant,
// donc jamais masquable par un réglage de visibilité par rôle (voir l'ancienne entrée
// `alwaysVisible` dans Layout.jsx#NAV_ITEMS, avant cette fusion). Le lien de menu fusionné
// reprend cette garantie (alwaysVisible sur l'entrée fusionnée, voir Layout.jsx) : même si
// 'documents' et 'my-approvals' sont masqués pour un rôle, le lien reste joignable et
// n'affiche alors que l'onglet Politique qualité. Chaque module reste une page complète et
// autonome, via des onglets calés sur les URLs historiques (/documents, /my-approvals,
// /quality-policy) — le lien direct entre Mes approbations et Documents est réel, pas
// seulement thématique : /workflows/mine et /procedures/pending-validations (voir
// MyApprovals.jsx) ne portent que sur des documents/procédures en attente de validation.
